...
const defaultLiveFeeds = [
  {
    type: 'sync',
    badge: 'LIVE WIKI SYNC',
    icon: RefreshCw,
    color: '#00e5ff',
    title: 'Real-Time Game Sync Active',
    message: '1,575 Pets and 144 In-Game Eggs continuously synced with BGS Wiki & Lua Stats.',
  },
  {
    type: 'egg',
    badge: 'NEW EGG SYNC',
    icon: Egg,
    color: '#ffcc00',
    title: '144 Complete Egg Rosters',
    message: 'Alien Egg, Hellish Egg, 1B Egg & all secret hatches fully updated with official 3D models.',
  },
  {
    type: 'value',
    badge: 'COLLAB VALUE UPDATE',
    icon: TrendingUp,
    color: '#10b981',
    title: 'Consensus Value Alignment',
    message: 'Sundae Champions & Secret pets updated to exact Collab list pricing; unpriced items strictly set to N/A.',
  },
  {
    type: 'secret',
    ...
    icon: Award,
    color: '#ec4899',
    title: 'Secret Hatches Monitored',
    message: 'Alien Kraken, Overlord, and Tophat series verified with drop probabilities.',
  },
];
